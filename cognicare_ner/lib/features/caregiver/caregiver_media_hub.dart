  ...
  Widget _buildPromptsTab() {
    ...
    return ListView(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        _PromptRecordCard(typeId: 'game_prompt_pattern', title: 'Pattern Sequencing', spokenText: loc.whatComesNext, onChanged: () => setState(() {})),
        const SizedBox(height: 16),
        _PromptRecordCard(typeId: 'game_prompt_faces', title: 'Face Recognition', spokenText: loc.whoIsThis, onChanged: () => setState(() {})),
        const SizedBox(height: 16),
        _PromptRecordCard(typeId: 'game_prompt_voice', title: 'Voice Recognition', spokenText: loc.whoseVoiceIsThis, onChanged: () => setState(() {})),
        const SizedBox(height: 16),
        _PromptRecordCard(typeId: 'game_prompt_name_completion', title: 'Name Completion', spokenText: loc.completeNamePrompt, onChanged: () => setState(() {})),
        const SizedBox(height: 16),
        _PromptRecordCard(typeId: 'game_prompt_routine', title: 'Routine Sequencing', spokenText: loc.gameDailyRoutine, onChanged: () => setState(() {})),
        const SizedBox(height: 16),
        _PromptRecordCard(typeId: 'game_prompt_objects', title: 'Object Naming', spokenText: loc.gameWhatIsThis, onChanged: () => setState(() {})),
        const SizedBox(height: 16),
